...
\fig{lightcontrol}{LightControl UI}{The user can drag around on the imaginary
  dome and change the lightning position.}
...
with the object. As the Paint plugin is interesting implementation wise it is
...
classy-mst. All future plugins will be automatically supported, as long as they
